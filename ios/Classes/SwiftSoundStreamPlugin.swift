...
public class SwiftSoundStreamPlugin: NSObject, FlutterPlugin {
    ...
    private var mRecordBufferSize: AVAudioFrameCount = 5460
    ...
    private var mPlayerBufferSize: AVAudioFrameCount = 5460
    ...
    private func resetEngineForRecord() {
        ...
        let ratio: Float = 2.0 // Float(inputFormat.sampleRate)/Float(mRecordFormat.sampleRate)
